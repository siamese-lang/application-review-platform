...
it('blocks non-administrators', async () => { view('REVIEWER'); expect(await screen.findByRole('alert')).toHaveTextContent('관리자 권한이 필요합니다'); expect(screen.queryByText('Admin content')).not.toBeInTheDocument() })
